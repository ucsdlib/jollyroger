...
-->
	...
	<xsl:template name="createGenreFrom336">
		<xsl:for-each select="*[local-name()='subfield' and @code='a']">
		<xsl:variable name="subfieldValue"><xsl:value-of select="."/></xsl:variable>
		<xsl:variable name="typeOfResource">
			<xsl:choose>
				<xsl:when test="$subfieldValue = 'cartographic dataset'">cartographic data</xsl:when>
				<xsl:when test="$subfieldValue = 'cartographic image'">cartographic</xsl:when>
				<xsl:when test="$subfieldValue = 'cartographic moving image'">cartographic moving image</xsl:when>
				<xsl:when test="$subfieldValue = 'cartographic tactile image'">cartographic</xsl:when>
				<xsl:when test="$subfieldValue = 'cartographic tactile three-dimensional form'">cartographic</xsl:when>
				<xsl:when test="$subfieldValue = 'cartographic three-dimensional form'">cartographic</xsl:when>
				<xsl:when test="$subfieldValue = 'computer dataset'">data</xsl:when>
				<xsl:when test="$subfieldValue = 'computer program'">software</xsl:when>
				<xsl:when test="$subfieldValue = 'notated movement'">notated movement</xsl:when>
				<xsl:when test="$subfieldValue = 'notated music'">notated music</xsl:when>
				<xsl:when test="$subfieldValue = 'performed music'">sound recording - musical</xsl:when>
				<xsl:when test="$subfieldValue = 'sounds'">sound recording - nonmusical</xsl:when>
				<xsl:when test="$subfieldValue = 'spoken word'">sound recording - nonmusical</xsl:when>
				<xsl:when test="$subfieldValue = 'still image'">still image</xsl:when>
				<xsl:when test="$subfieldValue = 'tactile image'">still image</xsl:when>
				<xsl:when test="$subfieldValue = 'tactile notated movement'">notated movement</xsl:when>
				<xsl:when test="$subfieldValue = 'tactile notated music'">notated music</xsl:when>
				<xsl:when test="$subfieldValue = 'tactile text'">text</xsl:when>
				<xsl:when test="$subfieldValue = 'tactile three-dimensional form'">three dimensional object</xsl:when>
				<xsl:when test="$subfieldValue = 'text'">text</xsl:when>
				<xsl:when test="$subfieldValue = 'three-dimensional form'">three dimensional object</xsl:when>
				<xsl:when test="$subfieldValue = 'three-dimensional moving image'">moving image</xsl:when>
				<xsl:when test="$subfieldValue = 'two-dimensional moving image'">moving image</xsl:when>
				<xsl:otherwise><xsl:value-of select="$subfieldValue"/></xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
